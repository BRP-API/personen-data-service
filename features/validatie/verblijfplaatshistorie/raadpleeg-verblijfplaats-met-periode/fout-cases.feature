...
@input-validatie
Functionaliteit: input validatie bij raadplegen verblijfplaats historie met periode
  ...
  Regel: datumVan een verplichte parameter in RFC 3339 (yyyy-mm-dd) formaat
  ...
  Regel: datumTot is een verplichte parameter in RFC 3339 (yyyy-mm-dd) formaat
  ...
  Regel: datumTot moet na datumVan liggen
  ...
  Regel: Alleen gespecificeerde parameters bij het opgegeven raadpleeg type mogen worden gebruikt
    ...
    @fout-case
    Abstract Scenario: De vraag bevat meerdere niet-gespecificeerde parameters
      Als verblijfplaatshistorie wordt gezocht met de volgende parameters
      | naam                             | waarde              |
      | type                             | RaadpleegMetPeriode |
      | burgerservicenummer              | 000000012           |
      ...
      | title    | Een of meerdere parameters zijn niet correct.                               |
      | status   | 400                                                                         |
      | detail   | De foutieve parameter(s) zijn: peildatum, adresseerbaarObjectIdentificatie. |
      | code     | paramsValidation                                                            |
      | instance | /haalcentraal/api/brphistorie/verblijfplaatshistorie                        |
      En heeft de response invalidParams met de volgende gegevens
      | code         | name                             | reason                      |
      | unknownParam | peildatum                        | Parameter is niet verwacht. |
      | unknownParam | adresseerbaarObjectIdentificatie | Parameter is niet verwacht. |
