...
Functionaliteit: adressering (adresregel) velden vragen met fields (gezag persoon beperkt)
  ...
  Regel: wanneer adresregel1 en/of adresregel2 velden van de adressering groep voor een persoon met een adres wordt gevraagd, dan wordt altijd de waarde van 'straatnaam (11.10)' en 'huisnummer (11.20)' geleverd
    ...
    Abstract Scenario: persoon heeft een adres met straatnaam, huisnummer en huisnummertoevoeging als verblijfplaats en adresregel1 wordt gevraagd
      ...
      | 0518                 | Daniël Stalpertstraat | 35                 | <huisnummertoevoeging>       | 0599010051001502                         |
      En de persoon met burgerservicenummer '000000188' is ingeschreven op adres 'A1' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0518                              |
      Als personen wordt gezocht met de volgende parameters
    ...
    Abstract Scenario: persoon heeft een adres met straatnaam, huisnummer en aanduiding bij huisnummer als verblijfplaats en adresregel1 wordt gevraagd
      Gegeven adres 'A1' heeft de volgende gegevens
      | gemeentecode (92.10) | straatnaam (11.10) | huisnummer (11.20) | aanduiding bij huisnummer (11.50) | identificatiecode verblijfplaats (11.80) |
      | 0518                 | Graan voor Visch   | 15201              | <aanduiding bij huisnummer>       | 0599010051001502                         |
      En de persoon met burgerservicenummer '000000188' is ingeschreven op adres 'A1' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0518                              |
      Als personen wordt gezocht met de volgende parameters
  ...
  Regel: wanneer groep adressering wordt gevraagd bij zoeken, dan worden de adresgegevens geleverd en niet naam of partner
    ...
    Scenario: adressering is gevraagd
      Gegeven adres 'A1' heeft de volgende gegevens
      | gemeentecode (92.10) | straatnaam (11.10)       | huisnummer (11.20) | postcode (11.60) | identificatiecode verblijfplaats (11.80) |
      | 0518                 | Jonkheer van Riemsdijkln | 88                 | 2583XL           | 0599010051001502                         |
