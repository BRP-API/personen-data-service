...
@api
Functionaliteit: persoon: in onderzoek leveren bij vragen om gegevens van ouders
  ...
  Regel: onderzoek wordt geleverd wanneer ten minste één gegeven uit die categorie is gevraagd
    ...
    Abstract Scenario: meerdere categorieën in onderzoek en <fields> uit categorie Ouder 1 en Ouder 2 wordt gevraagd
      ...
      | naam                                      | waarde   |
      | <fields>                                  | <waarde> |
      | inOnderzoek.aanduidingGegevensInOnderzoek | 020000   |
      | inOnderzoek.datumIngangOnderzoek          | 20230102 |

      Voorbeelden:
      | fields                                              | waarde    |
      | burgerservicenummer                                 | 222222222 |
      | datumIngangFamilierechtelijkeBetrekking             |           |
      | datumIngangFamilierechtelijkeBetrekking.langFormaat |           |
      | datumIngangFamilierechtelijkeBetrekking.type        |           |
      | datumIngangFamilierechtelijkeBetrekking.datum       |           |
      | datumIngangFamilierechtelijkeBetrekking.onbekend    |           |
