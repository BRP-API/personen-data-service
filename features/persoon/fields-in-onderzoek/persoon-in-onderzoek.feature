...
@api
Functionaliteit: persoon: in onderzoek leveren bij vragen om gegevens van persoon
  ...
  Regel: onderzoek wordt geleverd wanneer ten minste één gegeven uit die categorie is gevraagd
    ...
    Abstract Scenario: meerdere categorieën in onderzoek en <fields> uit categorie Persoon wordt gevraagd
