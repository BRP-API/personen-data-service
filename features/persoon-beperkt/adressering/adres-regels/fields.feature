...
Regel: wanneer adresregel1, adresregel2 en/of adresregel3 velden voor een persoon met een verblijfplaats buitenland wordt gevraagd, dan wordt de waarde van 'land (13.10)' ook geleverd
  ...
  Abstract Scenario: persoon heeft een verblijfplaats buitenland, 'regel 1 adres buitenland (13.30)' heeft geen waarde en adresregel1 wordt gevraagd
    ...
    | Maassen               | 19830526              |
    En de persoon is ingeschreven op een buitenlands adres met de volgende gegevens
    | land adres buitenland (13.10) | regel 2 adres buitenland (13.40) | regel 3 adres buitenland (13.50) |
  ...
  Abstract Scenario: persoon heeft een verblijfplaats buitenland, ' regel 2 adres buitenland (13.40)' heeft geen waarde en adresregel2 wordt gevraagd
    ...
    | Maassen               | 19830526              |
    En de persoon is ingeschreven op een buitenlands adres met de volgende gegevens
    | land adres buitenland (13.10) | regel 1 adres buitenland (13.30) | regel 3 adres buitenland (13.50) |
  ...
  Abstract Scenario: persoon heeft een verblijfplaats buitenland, 'regel 3 adres buitenland (13.50)' heeft geen waarde en adresregel3 wordt gevraagd
    ...
    | Maassen               | 19830526              |
    En de persoon is ingeschreven op een buitenlands adres met de volgende gegevens
    | land adres buitenland (13.10) | regel 1 adres buitenland (13.30) | regel 2 adres buitenland (13.40) |
...
Regel: wanneer groep adressering wordt gevraagd bij zoeken, dan worden de adresgegevens geleverd en niet naam of partner
  ...
  Scenario: adressering is gevraagd 
      ...
      En de persoon met burgerservicenummer '000000139' heeft de volgende gegevens
      | naam                                 | waarde    |
