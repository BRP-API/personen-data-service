...
@api
Functionaliteit: maximaal aantal zoekresultaten ZoekMetAdresseerbaarObjectIdentificatie
    ...
    Achtergrond:
      ...
      En de persoon met burgerservicenummer '000000021' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000022' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000023' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      ...
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000026' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000027' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000028' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000029' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000030' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
      En de persoon met burgerservicenummer '000000031' is ingeschreven op adres 'A2' met de volgende gegevens
      | gemeente van inschrijving (09.10) |
      | 0800                              |
