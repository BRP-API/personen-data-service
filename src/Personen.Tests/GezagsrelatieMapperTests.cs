...
namespace Personen.Tests
{
    public class GezagsrelatieMapperTests
    {
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, _gezagPersonen);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(null, _gezagPersonen);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, new List<GbaPersoon>());
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, _gezagPersonen_ZonderNaam);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, _gezagPersonen_ZonderGeslacht);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, _gezagPersonen_ZonderGeboorte);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse, _gezagPersonen_ZonderAdellijkeTitelPredicaat);
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse_Voogdij_ZonderDerden, new List<GbaPersoon>());
        ...
        {
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(_gezagResponse_TweehoofdigOuderlijkGezag_ZonderOuders, new List<GbaPersoon>());
        ...
        public void MapGezagsrelaties_Voogdij_ShouldReturn_Minderjarige_WhenMinderjarigeIsNull()
        {
            ...
            var gezagsrelaties = GezagsrelatieMapperDeprecated.Map(gezagResponse, _gezagPersonen);
        ...
        public void MapGezagsrelaties_GezamenlijkGezagMetBekendeDerde()
        {
            ...
            GezagsrelatieMapperDeprecated.Map(input, personen).Should().BeEquivalentTo(expected);
        }
        ...
        public void MapGezagsrelaties_GezamenlijkGezagMetOnbekendeDerde()
        {
            ...
            GezagsrelatieMapperDeprecated.Map(input, new List<GbaPersoon>()).Should().BeEquivalentTo(expected);
        }
    }
}
